    ...
    <TheModal :open-modal="props.open" size="4xl" @close-modal="closeModal">
        <template #header>
            <div class="flex justify-between items-center">
                <div class="font-medium text-lg">Edit User</div>
            ...
            <div v-else class="grid lg:grid-cols-12 gap-6">
                <div class="lg:col-span-12">
                    ...
                    <div class="grid lg:grid-cols-12 gap-5">
                        ...
                        <FormSelectField v-model="item.type_network" :select-data="networkTypes" labelvalue="name" keyvalue="value" class="lg:col-span-6" label="Network Type" name="type-network" placeholder="Select network type" />
                    </div>
                </div>
                ...
                <FormUploader v-model="item.image" class="lg:col-span-12" :allowed-types="['image']" label="Image" name="image" />
            </div>
        </template>
        <template #footer>
